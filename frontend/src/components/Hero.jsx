    ...
    <div className="relative z-0 bg-white">
      <div className="flex flex-col-reverse max-w-7xl mx-auto py-10 px-4 sm:py-24 sm:px-6 lg:px-8 lg:flex-row">
        <div className="space-y-8 lg:mt-28">
          ...
          >
            Donate your books and discover new stories. Join our community of
            book lovers, where every book finds a new home and every story
            inspires a new journey. Together, we can make a difference, one
            page, one story, and one reader at a time.
          </motion.p>
          <div className="flex space-x-4">
            ...
            >
              <Link
                to="/inventory"
                className="inline-flex items-center px-6 py-3 border border-gray-300 cursor-pointer text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 hover:drop-shadow-xl"
              >
                Browse Books
              </Link>
            </motion.div>
