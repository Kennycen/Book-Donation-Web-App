      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="flex-1 flex flex-col justify-center space-y-6">
          <motion.h2
            ...
            className="font-prata text-4xl font-bold text-gray-900"
          >
            About Us
          </motion.h2>
          <motion.p
          ...
          >
            This web app was created to connect students through book donations
            and sharing. Its purpose is to provide a convenient platform where
            students can donate books they no longer need and find books to
            support their studies. By fostering a culture of giving and reusing,
            reduces waste, and builds a stronger community.
          </motion.p>
          <motion.div
            initial={{ y: 30, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
