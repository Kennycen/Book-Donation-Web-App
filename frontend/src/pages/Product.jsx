...
import { useBook, useDeleteBook } from "../hooks/useBook";

const Product = () => {
  const { productId } = useParams();
  const navigate = useNavigate();
  const { book, isLoading, error } = useBook(productId);
  const { deleteBook, isDeleting, error: deleteError } = useDeleteBook();
            ...
            <div className="md:flex">
              ...
              <div className="md:flex-shrink-0 md:w-1/3">
                <img
                  ...
                  alt={book.title}
                  className="w-full h-96 object-contain bg-gray-100 md:h-full rounded-lg"
                  loading="eager"
                  onError={(e) => {
              ...
              <div className="p-8 md:w-2/3">
                ...
                <p className="mt-2 text-gray-600">ISBN: {book.isbn}</p>
                ...
                <div className="mt-8 border-t pt-6">
                  ...
                  >
                    {isDeleting
                      ? "Deleting..."
                      : "Delete Book (Mark as Donated)"}
                  </button>
                  <p className="mt-2 text-sm text-gray-500 text-center">
                    Click this button when the book has been donated to another
                    person
                  </p>
                </div>
              </div>
